...
lazy_static! {
    ...
    static ref RANDOM_ADDRESS: Address = "mgR9fN5UzZ64mSUUtk6NwxxS6kwVfoEtPG".parse::<Address<_>>().unwrap().assume_checked();
...
fn test_list_unspent(cl: &Client) {
    ...
    assert_eq!(unspent[0].address.clone().unwrap().assume_checked(), addr);
